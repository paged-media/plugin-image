 ...
 */
export function text_paint(handle: number, font_bytes: Uint8Array, text: string, size_px: number, x: number, y: number, color: Float32Array, tracking_per_mille: number, leading_px: number, baseline_shift_px: number, h_scale: number, v_scale: number, skew_deg: number, underline: number, strikethrough: number, ligatures: number, align: number): Promise<number>;
...
export interface InitOutput {
    ...
    readonly text_paint: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number) => any;
